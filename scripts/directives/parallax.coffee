            ...
            link: ($scope, elem, $attrs) ->
                ...
                if isNotMobile
                    setPosition = ->
                        ...
                        calcValY = $window.pageYOffset * ((if $scope.parallaxRatio then $scope.parallaxRatio else 1.1))
                        if calcValY <= $window.innerHeight
                            topVal = ((if calcValY < $scope.parallaxVerticalOffset then $scope.parallaxVerticalOffset else calcValY))
                            elem.css "top", topVal + "px"
                            elem.css "margin-bottom", topVal + "px"
                        return
    ...
    ($window) ->
        return (
            ...
            link: ($scope, elem, attrs) ->
                ...
                if isNotMobile
                    setPosition = ->
                        calcValY = (elem.prop("offsetTop") - $window.pageYOffset) * ((if $scope.parallaxRatio then $scope.parallaxRatio else 1.1))
