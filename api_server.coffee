...
app.get "/app/:appname" + "/package/:package" + "/youtube/:youtube" + "/color/:color" + "/icon/:icon" + "/twitter/:twitter" + "/facebook/:facebook" + "/gplus/:gplus" + "/welcome_title/:welcome_title" + "/welcome_desc/:welcome_desc" + "/api_key/:api_key", (req, res) ->
