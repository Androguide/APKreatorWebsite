...
public class CardGplus extends Card {
    ...
    public CardGplus(String username, String annotation, String avatarUrl, String imageUrl, String imageTitle, String resharedDesc, String resharedText,
                     String resharedFrom, String originalTitle, int plusOnes, Boolean isReshared) {
        super(username, annotation, avatarUrl, imageUrl, imageTitle, resharedDesc, resharedText, resharedFrom, originalTitle, plusOnes, isReshared);
    }
    ...
    public View getCardContent(Context context) {
        ...
        if (v != null) {
            ...
            ((TextView) v.findViewById(R.id.description)).setText(Html.fromHtml(annotation));
            ((TextView) v.findViewById(R.id.articleTitle)).setText(imageTitle);
            ((TextView) v.findViewById(R.id.resharedText)).setText(Html.fromHtml(resharedText));
            ((TextView) v.findViewById(R.id.reshared)).setText(Html.fromHtml("<b>" + resharedFrom + "</b> originally shared this"));
