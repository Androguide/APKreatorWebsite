...
import com.androguide.apkreator.fragments.GplusFragment;
import com.androguide.apkreator.fragments.WelcomeFragment;
import com.androguide.apkreator.fragments.YouTubeFragment;
...
public class MainActivity extends ActionBarActivity implements
    ...
    private String mDrawerHeaders[] = {"Website", "Follow Me on Twitter", "Follow Me on Google+", "Become a Fan"};
    private String mAppColor = "#3f9fe0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new File(getFilesDir() + "/.APKreator/icon.png").exists()) {
            try {
    ...
    /**
     * Method which checks if the configuration files exist in data/data/{package-name}/files/.APKreator
     * If they don't, it copies a default configuration over from the assets
     */
    ...
    public void setAppConfigInPrefs() {
        ...
        for (int i = 0; i < (pluginConfigs != null ? pluginConfigs.size() : 0); i++) {
            mAppColor = pluginConfigs.get(i).getAppColor();
            prefs.edit()
                    ...
                    .putString("YOUTUBE_USER", pluginConfigs.get(i).getYoutubeUser())
                    .putString("WELCOME_TITLE", pluginConfigs.get(i).getWelcomeTitle())
                    .putString("WELCOME_DESC", pluginConfigs.get(i).getWelcomeDesc())
                    .putString("DEVELOPER_KEY", pluginConfigs.get(i).getDeveloperKey())
                    .putInt("TABS_AMOUNT", pluginConfigs.get(i).getTabsAmount())
                    .putInt("CPU_CONTROL_POS", pluginConfigs.get(i).getCpuControlPos())
                    .putInt("CORDOVA_POS", pluginConfigs.get(i).getPhoneGapFragmentPos())
                    .putInt("CORDOVA_POS", pluginConfigs.get(i).getPhoneGapFragmentPos())
                    .commit();
        }
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        /**
         * Retrieve the color from the #Bundle and set the color scheme to its value
         * @see #changeColor()
         */
